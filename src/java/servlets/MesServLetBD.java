 ...
 * @author Usuario
 */
@WebServlet(name = "MesServLetBD", urlPatterns = {"/MesServLetBD"})
public class MesServLetBD extends HttpServlet {
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			String datosBD = opBD.consultarHoroscopoMes(signo);
			...
			out.println("<a href=\"optionalPages/horoscopoMes.jsp\" >Back page</a>");
			out.println("</main>");
