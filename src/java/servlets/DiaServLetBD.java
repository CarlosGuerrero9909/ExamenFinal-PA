 ...
 * @author Usuario
 */
@WebServlet(name = "DiaServLetBD", urlPatterns = {"/DiaServLetBD"})
public class DiaServLetBD extends HttpServlet {
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			String datosBD = opBD.consultarHoroscopoDia(signo);
			...
			out.println("<a href=\"optionalPages/horoscopoDia.jsp\" >Back page</a>");
			out.println("</main>");
